...
public abstract class Entity {
	...
	public void update() {
		 ...
		 * 
		 * MAP :
		 * - Generate a leveldata :
		 * 		-> {
		 * 				[' ', ' ', ' ', ' ', ' ']
		 * 				['S', 'S', 'S', ' ', 'S']
		 * 				['L', 'L', 'L', 'L', 'L']
		 * 			}
		 * 		-> Game.registerBlock(<? extends Block>, char) : void
		 * 		-> Game.getLevelData()[][] : char <!-- get the neighbor block with that -->
		 * 
		 * 		-> LevelData generated by block unit placement
		 */
